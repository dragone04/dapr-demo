...
sudo dapr run --app-id api-rabbit-producer --app-port 9004 --dapr-http-port 3000 -- mvn compile quarkus:run
...
You can then execute your native executable with: `./target/api-rabbit-producer-1.0.0-SNAPSHOT-runner`
