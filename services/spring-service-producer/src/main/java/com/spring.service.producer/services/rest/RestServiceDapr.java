...
@RestController
public class RestServiceDapr {

    private static final Logger LOGGER = LoggerFactory.getLogger(RestServiceDapr.class);
    ...
    public RestServiceDapr(HttpService httpService) {
