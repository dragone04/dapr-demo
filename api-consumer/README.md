...
sudo dapr run --app-id api-rabbit-consumer --app-port 9005 --dapr-http-port 3003 -- mvn compile quarkus:run

sudo dapr run --app-id api-rabbit-consumer --app-port 9005 --dapr-http-port 3003 -- java -jar target/api-rabbit-consumer-dev.jar
...
You can then execute your native executable with: `./target/api-rabbit-consumer-1.0.0-SNAPSHOT-runner`
