package com.spring_performance_a.services.rest;
...
import com.spring_performance_a.services.HttpService;
...
@RestController
public class PerformanceAServiceNoDapr {

    private static final Logger LOGGER = LoggerFactory.getLogger(PerformanceAServiceNoDapr.class);
    ...
    public PerformanceAServiceNoDapr(HttpService httpService) {
